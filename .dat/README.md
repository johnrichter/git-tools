...
description: "In-repo home for plan-with-team / build-with-team plans and builds — one directory per effort under .dat/<slug>/, tracked in git so delivery-agent-team can plan, build, resume, and release in-repo. Transitional: to be retired in favor of .anoikis/."
