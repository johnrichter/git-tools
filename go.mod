module github.com/johnrichter/git-tools
...
require (
	...
	github.com/johnrichter/claude-shared-tooling/go/git v0.1.0
	github.com/johnrichter/claude-shared-tooling/go/githooks v0.1.0
